...
describe 'Knife::Windows::Core msi download functionality for knife Windows winrm bootstrap template' do 
  ...
  it "returns true if the Windows batch file bootstrap template can be rendered" do
  ...
  describe "running on any verion of the Windows OS", :windows_only do 
    it "returns true if the msi download succeeds when the Windows batch file is executed via winrm" do 
  ...
  describe "running on Windows Server 2012", :windows_2012_only do
    it "returns true if the msi download fails when the PowerShell download workaround is disabled" do
